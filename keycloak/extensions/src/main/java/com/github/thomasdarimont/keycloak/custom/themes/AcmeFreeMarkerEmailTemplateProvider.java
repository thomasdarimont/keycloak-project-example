...
package com.github.thomasdarimont.keycloak.custom.themes;
 ...
 */
public class AcmeFreeMarkerEmailTemplateProvider implements EmailTemplateProvider {
    ...
    public AcmeFreeMarkerEmailTemplateProvider(KeycloakSession session, FreeMarkerUtil freeMarker) {
