...
public class AcmeFreeMarkerEmailTemplateProviderFactory implements EmailTemplateProviderFactory {

    private FreeMarkerUtil freeMarker;

    @Override
    public EmailTemplateProvider create(KeycloakSession session) {
        return new AcmeFreeMarkerEmailTemplateProvider(session, freeMarker);
    }
