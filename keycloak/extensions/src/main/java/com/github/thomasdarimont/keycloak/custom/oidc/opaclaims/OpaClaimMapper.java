...
import com.github.thomasdarimont.keycloak.custom.auth.opa.AuthZen;
import com.github.thomasdarimont.keycloak.custom.auth.opa.OpaCheckAccessAction;
...
public class OpaClaimMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper {
    ...
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession, KeycloakSession keycloakSession, ClientSessionContext clientSessionCtx) {
        ...
        if (accessResponse == null || accessResponse.getResult() == null) {
            return;
        }
