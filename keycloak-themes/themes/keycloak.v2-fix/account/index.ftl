...
<head>
    ...
    <!-- PATCH fix inconsitent path generation in new account console in Keycloak 12.0.4 -->
    <!-- this is solved in Keycloak 13.0.x: https://github.com/keycloak/keycloak/blob/master/services/src/main/java/org/keycloak/services/resources/account/AccountConsole.java#L98 -->
